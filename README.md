...
Note that Requests and Responses responses are logged in an addition table API_REQUEST_LOGS

| id | api_name        | create_at               | direction | request_body                                                                                                     | request_path                        | request_url                                                                                                   | response_body                                                                                                                                                                                   | RESPONSE_CODE | TRANSACTION_ID |
|----|-----------------|-------------------------|-----------|------------------------------------------------------------------------------------------------------------------|-------------------------------------|---------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|----------------|
| 1  | TRANSACTION_API | 2026-05-17 20:36:44.000 | INCOMING | {"description":"Coffee shop","transactionDate":"2024-03-30","purchaseAmount":100.00,"uniqueIdentifier":"txn-001"} | /api/transactions                   | http://localhost:8080/api/transactions                                                                        | {"uniqueIdentifier":"txn-001","description":"Coffee shop","transactionDate":"2024-03-30","purchaseAmount":100.00}                                                                               | 201           | 1              |
| 2  | TREASURY_API    | 2026-05-17 20:37:20.000 | OUTGOING | {"startWindow":"2023-09-30","currency":"Canada-Dollar"}	                                                         | /v1/accounting/od/rates_of_exchange | https://api.fiscaldata.treasury.gov/services/api/fiscal_service/v1/accounting/od/rates_of_exchange?fields=... | [{"country_currency_desc":"Canada-Dollar","exchange_rate":"1.355","record_date":"2024-03-31"},{"country_currency_desc":"Canada-Dollar","exchange_rate":"1.326","record_date":"2023-12-31"},...] | 200           | 1              |
| 3  | TRANSACTION_API | 2026-05-17 20:37:20.000 | INCOMING | {"currency":"Canada-Dollar"}	                                                                                     | /api/transactions/txn-001	       | http://localhost:8080/api/transactions/txn-001?currency=Canada-Dollar	                                       | {"uniqueIdentifier":"txn-001","description":"Coffee shop","transactionDate":"2024-03-30","purchaseAmount":100.00,"exchangeRate":1.326,"convertedAmount":132.60}	                             | 200           | 1              |
